...
load_dotenv()
TELEGRAM_BOT_TOKEN = os.getenv('TELEGRAM_BOT_TOKEN') or "7850276923:AAHtlpa-L0MQgf8qpFWt1MJFWmT1WooRf0A"
WEBHOOK_DOMAIN = os.getenv('RAILWAY_PUBLIC_DOMAIN') or "https://muradali.railway.internal"  # HTTPS kerak
